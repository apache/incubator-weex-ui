...
// ga
(function(){function a(){var e=document.createElement("script");e.async=true;e.src="https://www.google-analytics.com/analytics.js";document.body.appendChild(e)}function d(e){a();window.ga=window.ga||function(){(window.ga.q=window.ga.q||[]).push(arguments)};window.ga.l=Number(new Date());window.ga("create",e,"auto")}function c(){if(!window.ga){d($docsify.ga)}window.ga("set","page",location.hash);window.ga("send","pageview")}var b=function(e){if(!$docsify.ga){console.error("[Docsify] ga is required.");return}e.beforeEach(c)};$docsify.plugins=[].concat(b,$docsify.plugins)}());
